...
/* Создание плавающих романтичных огоньков */
function initFloatingParticles() {
    ...
    for (let i = 0; i < count; i++) {
        ...
        particle.style.top = `${100 + Math.random() * 20}%`; // Начинают снизу экрана
...
/* Появление элементов с поддержкой тач-устройств и скролла */
...
/* Просмотр фото на весь экран при клике */
...
/* Эффект волшебных искр при клике / касании пальцем */
